...
export function createNotifyCore({ stateDir, portProvider, configProvider, logger = null }) {
   ...
   * @param {{title?: string, message?: string, detail?: string, sound?: string, soundOn?: boolean}} options
   */
  function notifyWindows({ title = "DeepSeek Harness", message = "", detail = void 0, sound = void 0, soundOn = void 0 } = {}) {
    ...
    try {
      ...
      const quiet = inQuietHours(config.quietHours) ? "badge-only" : "none";
      const payload = {
