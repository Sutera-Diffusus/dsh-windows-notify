...
/** Best-effort DSH install root, used to scope the tray Exit action to this copy only. */
function resolveInstallRoot() {
   try {
      const envRoot = process.env.DSH_INSTALL_DIR;
      if (typeof envRoot === "string" && envRoot.trim() !== "") return envRoot.trim();
