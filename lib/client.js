...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    // 按钮一律用框架原语(主题对比度由框架保证,与设置页其他控件完全一致)
    ...
    function SwitchRow(props) {
      ...
      return react_jsx_runtime.jsxs("div", { style: style.toggle, children: [
        ...
        react_jsx_runtime.jsx(primitives.Button, { variant: checked ? "primary" : "outline", size: "sm", onClick: onToggle, children: checked ? "开启" : "关闭" }),
      ] });
    }
    ...
    function NotifySection() {
      ...
      return react_jsx_runtime.jsxs("div", { style: style.root, children: [
        ...
        error !== null ? react_jsx_runtime.jsxs("div", { style: style.error, role: "alert", children: [
          error,
          react_jsx_runtime.jsx(primitives.Button, { variant: "outline", size: "sm", onClick: load, children: "重试" }),
        ] }) : null,
